        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 relative z-10">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] bg-slate-800 text-slate-300 font-mono font-medium px-2 py-0.5 rounded">
                  EDICIÓN 2026
                </span>
              </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl border border-red-950/40 hover:bg-red-950/20 text-red-400 text-xs font-semibold flex items-center gap-1.5 transition-all"
            ...
            {/* Quick stats totals */}
            <div className="bg-slate-950/80 px-4 py-2 rounded-xl border border-slate-900 text-right min-w-[120px]">
              <span className="text-[10px] text-slate-500 block uppercase tracking-wider font-bold">Participantes</span>
              <span className="text-lg font-black text-white font-mono">{employees.length}</span>
            </div>
          </div>
        </div>
      </header>
          ...
          {activeTab === "LISTA" && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div id="fixtures-list-container" className="grid grid-cols-1 md:grid-cols-2 gap-4">
